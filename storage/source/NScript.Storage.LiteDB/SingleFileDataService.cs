...
/// </summary>
public class SingleFileDataService<TEntity> : MultiFileDataService<TEntity> where TEntity : class
{
    private string DataBaseName { get; set; } = "singlefile";

    public SingleFileDataService(string databaseName, string? baseDir = null)
    {
